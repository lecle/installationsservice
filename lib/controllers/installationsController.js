...
exports.create = function createUsers(req, res, container) {
    ...
    container.getService('MONGODB').then(function(service) {
        ...
        service.send('findOne', {collectionName : req.session.appid, query : {where : {deviceType : data.deviceType, deviceToken : data.deviceToken}}}, function(err, doc) {
            ...
            data._className = '_Installations';
...
exports.destroyAll = function(req, res, container) {
    ...
    container.getService('MONGODB').then(function(service) {
        ...
        service.send('remove', {collectionName : req.session.appid, query : {_className : '_Installations'}}, function(err, doc) {
